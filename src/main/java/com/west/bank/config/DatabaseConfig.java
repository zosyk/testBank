...
@Configuration
@EnableJpaRepositories("com.west.bank.repository")
...
//        ds.setInitialSize(Integer.valueOf(env.getRequiredProperty("db.initialiSize")));
//        ds.setMinIdle(Integer.valueOf(env.getRequiredProperty("db.minIdle")));
//        ds.setMaxIdle(Integer.valueOf(env.getRequiredProperty("db.maxIdle")));
//        ds.setTimeBetweenEvictionRunsMillis(Integer.valueOf(env.getRequiredProperty("db.timeBetweenEvictionsRunMillis")));
