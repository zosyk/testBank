...
function callBackLoad(data) {
    ...
    for (var i=0;i!=size;++i) {
        ...
        table += "<tr><td>"+data.creditCards[i].cardType+"</td><td>"+data.creditCards[i].cardNumber+"</td><td>"+data.creditCards[i].cardValue+" \$</td><td>" + "<a href=" + "/getClient?id=" +  data.creditCards[i].id +  " >Watch History</a>" + "</td></tr>"
    }
    table += "</table>"
